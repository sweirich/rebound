...
-- | Lambda calculus with constructor patterns and pair patterns, where
-- the number of variables a pattern binds is not statically fixed.
--
-- Agda transcription of @rebound/examples/Pat.hs@.
module Pat where
